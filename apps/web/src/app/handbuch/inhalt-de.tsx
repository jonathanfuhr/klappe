...
/**
 * Das Handbuch auf Deutsch (Phase 26).
 *
 * Lange Fließtexte mit Auszeichnung stehen als ganze Sprachfassung nebeneinander
 * und nicht als hunderte Satzfragmente im Wörterbuch: Ein Absatz mit
 * `<strong>`, `<code>` und Tabellen ließe sich sonst nur zerstückelt
 * übersetzen, und beim nächsten Umformulieren passte die Zerlegung nicht mehr.
 * Die kurzen Bedienungstexte der Oberfläche bleiben im Wörterbuch.
 *
 * Derselbe Inhalt liegt zusätzlich als Markdown unter `docs/handbuch.md`.
 */
export const ABSCHNITTE_DE = [
      ...
      <section id="anmelden" className="card manual__section">
          ...
          <section id="konto" className="card manual__section">
            ...
            <p>
              ...
              gleichermaßen. Dort steht auch die <strong>Sprache</strong> von Oberfläche und
              eigenen E-Mails; ohne eigene Wahl gilt die Einstellung des Workspace.
            </p>
            <p>
          ...
          <section id="einstellungen" className="card manual__section">
            ...
            <ul>
              ...
              <li><strong>Erscheinungsbild</strong> – Titel, Logo, Akzentfarbe und Sprache des Workspace.</li>
              ...
              <li><strong>awork</strong> – die Anbindung ans Projektmanagement: Korrekturen zu einer Fassung werden dort zur Aufgabe, die Eingetragenen stehen als Bearbeiter darin (ab Werk aus). Damit ein Projekt sein Gegenstück findet, muss auf beiden Seiten dieselbe <strong>Projektnummer</strong> im jeweiligen Freifeld stehen – ohne sie geht nichts hinaus.</li>
