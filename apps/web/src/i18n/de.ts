...
export const de = {
  ...
  'toolbar.sortCurrent': 'Sortierung: {name}, {direction}',
  'toolbar.sortDirection': 'Reihenfolge',
  'setup.title': 'Willkommen bei Klappe',
  'setup.intro':
    'Diese Anlage ist noch leer. Lege hier das erste Konto an – es bekommt Administratorrechte und richtet danach alles Weitere ein.',
  'setup.name': 'Dein Name',
  'setup.passwordRepeat': 'Passwort wiederholen',
  'setup.passwordMismatch': 'Die beiden Passwörter stimmen nicht überein.',
  'setup.submit': 'Konto anlegen und loslegen',
  'setup.working': 'Wird angelegt …',
  'toolbar.sortAsc': 'Aufsteigend',
  'toolbar.sortDesc': 'Absteigend',
  ...
  'video.chipVisible': 'Veröffentlicht',
