...
export const en: Record<MessageKey, Message> = {
  ...
  'toolbar.sortCurrent': 'Sorting: {name}, {direction}',
  'toolbar.sortDirection': 'Order',
  'setup.title': 'Welcome to Klappe',
  'setup.intro':
    'This installation is still empty. Create the first account here – it gets administrator rights and sets up everything else.',
  ...
  'comments.pinAtTime': 'Pin to {time}',
  ...
  'aiKind.voice': 'AI voice',
  'aiKind.video': 'AI video',
  'aiKind.sounds': 'AI sounds',
  'aiKind.music': 'AI music',
