...
| 27 | **Externe Anbindung:** API-Zugriff für Plugins, Skripte und spätere Apps – ab Werk abgeschaltet, vom Admin unter *Einstellungen → API-Zugriff* freizugeben. Geräte verbinden sich über eine Kopplung im Browser (Code vom Gerät bestätigen), es wandert also kein Passwort ins Plugin und Microsoft 365 funktioniert unverändert mit. Jeder trennt seine eigenen Geräte unter *Mein Konto*, der Admin alle. Entwicklerleitfaden in [docs/plugin-entwicklung.md](docs/plugin-entwicklung.md) |
